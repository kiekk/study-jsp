         ...
         <center>
            <table  border="1" cellpadding="0" cellspacing="0" width="25%">
               ...
               <tr height="40px">
                  ...
                  <td>
                  	  <input type="text" name="member_id" style="width:230px;" onchange="changeValue()"/>
                  	  <a href="javascript:checkId(joinForm.member_id.value)">중복확인</a>
                  	  <p id="checkId_text" style="color:red; font-weight:bold; font-size:14px; text-indent:10px; margin:5px 0;"> </p>
