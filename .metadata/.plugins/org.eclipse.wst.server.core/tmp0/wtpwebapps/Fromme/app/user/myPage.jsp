      ...
      <article>
		...
		<div style="width:72%; float:left; height:1000px;">
			<div style="background-color:white; height:250px; margin:0 auto; margin-bottom:20px;">
				<br><label style="margin-left: 5%; font-size:20px;">이런 클래스는 어떤가요?</label><br>
				<label style="margin-left:5%;">오늘의 추천 클래스</label>
			</div>
			<div style="background-color:white; height:250px; margin:0 auto; margin-bottom:20px;">
				<br><label style="margin-left: 5%; font-size:20px;">최근 예약내역</label>
				<br><p></p>
			</div>
			<div style="background-color:white; height:250px; margin:0 auto; margin-bottom:20px;">
				<br><label style="margin-left: 5%; font-size:20px;">최근 본 상품</label>
				<br><p></p>
			</div>
		</div>
		</div>
